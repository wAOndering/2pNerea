...
path='Z:\Nerea\2 photon imaging\SynapticActivityneuropilTest13ROI_4'
...
sizeSeed=32; % multiple of 2 / size of the region of interest
randN=1:1:sizeSeed % create a set number of mask with given position
